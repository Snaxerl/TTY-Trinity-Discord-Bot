...
client.on("guildMemberAdd", async (member) => {
  ...
  const embed = new MessageEmbed()
    ...
    .setDescription(
      `**${member.displayName}** Willkommen bei ${member.guild.name}, wir haben nun ${member.guild.memberCount} Mitglieder!`
    );
...
client.on("guildMemberRemove", async (member) => {
  ...
  const embed = new MessageEmbed()
    ...
    .setDescription(
      `**${member.displayName}** hat ${member.guild.name} verlassen, wir haben nun ${member.guild.memberCount} Mitglieder!`
    );
